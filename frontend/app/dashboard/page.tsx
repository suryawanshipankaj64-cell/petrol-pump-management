    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card">
          ...
          <CardContent>
            {/* Chart placeholder */}
            <div className="h-64 bg-dark-card/50 rounded-xl flex items-center justify-center">
              <p className="text-dark-muted">📈 Chart.js integration coming</p>
            </div>
          </CardContent>
        </div>
        <div className="card">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="w-full bg-dark-card rounded-full h-2">
                <div className="bg-primary-500 h-2 rounded-full w-62%"></div>
              </div>
              <div className="flex justify-between">
                <span>Diesel</span>
              ...
              <div className="w-full bg-dark-card rounded-full h-2">
                <div className="bg-orange-500 h-2 rounded-full w-38%"></div>
              </div>
            </div>
          </CardContent>
        </div>
